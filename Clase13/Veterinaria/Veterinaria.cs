...
namespace Veterinaria
{
  class Veterinaria
  {
    ...
    public decimal ImporteTotalGatos()
    {
      ...
      return atenciones.OfType<AtencionMedica>()
      .Where(x => x.Mascota.Especie == Especie.Gato)
      .Sum(x => x.ImporteACobrar());
    }
    ...
    public AtencionMedica? primerAtencionMedicaGato()
    {
      ...
      return atenciones.OfType<AtencionMedica>().Where(x => x.Mascota.Especie == Especie.Gato).FirstOrDefault();
    }
